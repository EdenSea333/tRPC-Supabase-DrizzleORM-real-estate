      ...
      <>
        ...
        <div className="absolute w-4/12 border-solid border-2 border-slate-500 rounded-md bg-white">
            <div className="flex flex-col items-center ">
                <h1 className="m-7 text-3xl font-bold text-black  text-shadow-default " style={{textShadow: '1px 1px 1px #000000'}}>Sign In</h1>
                <Form {...form}>
                    <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                          <FormLabel className="text-sm text-black m-2" style={{textShadow: '0px 0px 1px #000000'}}>Password</FormLabel>
                            ...
                            <FormMessage />
                            <FormLabel className="text-xs text-blue-500 m-1 items-right" >Forget Password?</FormLabel>
                        </FormItem>                      
                    )}
                    />
                    ...
                    <div className="">
                        <FormLabel className="text-sm text-black m-1" style={{textShadow: '0px 0px 1px #000000'}}>Don't you have an account?</FormLabel>
                        <Link href="/authentication/signup">
                          <FormLabel className="text-lg text-blue-500 m-1" style={{textShadow: '1px 1px 1px #ffffff'}}>Sign Up</FormLabel>
                        </Link>
                    </div>
                    <FormLabel className="text-md text-black m-1" style={{textShadow: '1px 1px 1px #ffffff'}}>----------or----------</FormLabel>
                    <div className="hidden sm:inline">
                        <div className="flex justify-end m-1 xl:w-96 lg:w-64 md:w-48 sm:w-32">
                            <Button type="submit" className="mb-0 bg-white text-blue-500 text-md border-solid border-2 border-blue-500">Sign In as a Client</Button>
                        </div>
                    </div>
                    <div className="items-center text-center mt-0 border-b-4 border-black rounded-xl mb-3 p-3">
                        <div className="flex">
                            <FormLabel className="text-sm text-black" style={{textShadow: '1px 1px 1px #ffffff'}}>By sign in, you agree to our</FormLabel>
